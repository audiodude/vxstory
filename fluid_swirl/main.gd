...
func get_schema() -> Dictionary:
	return {
		...
		"params": [
			...
			PS.f("noise_strength", 2.0, 0.0, 3.0, {"macro": {"name": "turbulence", "lo": 0.5, "hi": 3.0}}),
			PS.f("noise_scale", 3.0, 1.0, 8.0),
			PS.f("dissipation", 0.995, 0.9, 1.0, {"macro": {"name": "viscosity", "lo": 0.98, "hi": 1.0}}),
			PS.f("flow_speed", 3.0, 0.2, 4.5, {"macro": {"name": "flow", "lo": 1.2, "hi": 4.5}}),
			PS.i("vortex_count", 6, 0, 8, {"live": false}),
			PS.f("vortex_strength", 1.6, 0.0, 2.4, {"macro": {"name": "turbulence", "lo": 0.4, "hi": 2.4}}),
			PS.i("injector_count", 8, 1, 8, {"live": false}),
			PS.f("inject_radius", 140.0, 20.0, 200.0),
			PS.f("inject_strength", 0.6, 0.05, 1.0),
			PS.f("injector_speed", 0.5, 0.05, 1.0),
