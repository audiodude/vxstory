...
func get_schema() -> Dictionary:
	return {
		...
		"params": [
			...
			PS.f("g_strength", 60000000.0, 10000000.0, 250000000.0, {"macro": {"name": "accretion", "lo": 25000000.0, "hi": 90000000.0}}),
			PS.f("core_radius", 100.0, 20.0, 150.0),
			PS.i("critical", 1500, 100, 6000, {"macro": {"name": "critical_mass", "lo": 300, "hi": 1730}}),
			PS.f("orbit_factor", 0.6, 0.35, 1.3, {"macro": {"name": "chaos", "lo": 0.85, "hi": 0.42}}),
			...
			PS.f("trail_persist", 0.025, 0.01, 0.5, {"macro": {"name": "chaos", "lo": 0.012, "hi": 0.05}}),
